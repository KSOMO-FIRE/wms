...
public interface GoodsMapper extends BaseMapper<Goods> {
    ...
    @Select("SELECT id, name, storage, goodsType, count, remark, imageUrl, productionDate, specification, shelfDate,price,isNearExpiry,isLowStock FROM goods  ${ew.customSqlSegment}")
